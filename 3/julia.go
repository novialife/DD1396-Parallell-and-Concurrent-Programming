...
// Placing the anonymous go routine inside the second for-loop does not
// speed the program.
// "If the work units are too small, the adminis­trative over­head of divi­ding
// the problem and sched­uling sub-problems might be too large. "
// Important to keep go rountines between 100 microseconds to 1ms.
// First rule of efficient parallel computation!!
